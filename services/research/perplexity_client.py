...
## 報道の原則
1. **時系列の明確化**: いつ起きたことなのかを明記（「○月○日」「先週」「先月」など）
2. **事実の正確性**: 確認された事実のみを報道し、憶測は避ける
3. **5W1H**: Who（誰が）、What（何を）、When（いつ）、Where（どこで）、Why（なぜ）、How（どのように）を明確に
4. **柔軟な期間設定**: 
   - 優先順位1: **直近1ヶ月以内**のニュースや大きな動きを探す
   - 優先順位2: もし1ヶ月以内に特筆すべきニュースがない場合は、**過去3〜6ヶ月**まで範囲を広げて、最も関連性の高いトピックを探す
   - **重要**: 「ニュースがありませんでした」という回答は禁止。期間を広げてでも必ず何か話題を見つけること
...
直近1ヶ月以内を中心に、関連性の高いニュースをトップ3つ選び、各ニュースについて事実・背景・影響・反応を詳しく報告してください。"""
