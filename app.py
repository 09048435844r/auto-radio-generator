...
def create_ui() -> gr.Blocks:
    ...
    with gr.Blocks(
        title="自動ラジオ動画生成システム v3.1"
    ) as app:
        
        # ヘッダー
        gr.Markdown(
            """
            # 🎙️ 自動ラジオ動画生成システム v3.1
        ...
        gr.Markdown(
            """
            ---
            *自動ラジオ動画生成システム v3.1 | Powered by Perplexity, Gemini, VOICEVOX, FFmpeg*
            """
        )
